...
\subsection{Ab Initio Molecular Dynamics and Car--Parrinello Molecular Dynamics}
...
The High-Accuracy Large-scale Molecular Dynamics (HALMD) package is a high-performance,
open-source molecular dynamics (MD) simulation framework designed for large-scale studies
...
\cite{zhong2025hydrogen}. HALMD energies are reported at single-precision
accuracy.}
